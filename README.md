...
[![Docs](https://img.shields.io/badge/iOS%20Docs-OK-blue.svg)](https://twilio.github.io/twilio-video-ios/docs/latest_2.x/index.html)

# Twilio Video Quickstart for iOS

> NOTE: These sample applications use the Twilio Video 2.x APIs. For examples using our 3.x APIs, please see the [master](https://github.com/twilio/video-quickstart-ios/tree/master) branch. For examples using our 1.x APIs, please see the [1.x](https://github.com/twilio/video-quickstart-ios/tree/1.x) branch.
> 
...
* [Docs](https://twilio.github.io/twilio-video-ios/docs/latest_2.x/index.html)

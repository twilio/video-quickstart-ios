...
This example requires Xcode 12.0 and the iOS 14.0 SDK, as well as a device running iOS 11.0 or above. While the app launches on an iPhone Simulator, ReplayKit is non-functional.
